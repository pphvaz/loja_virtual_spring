...
import pphvaz.lojaspring.enums.StatusContaAPagar;

@Entity
@Table(name = "conta_a_pagar")
@SequenceGenerator(name = "seq_conta_a_pagar", sequenceName = "seq_conta_a_pagar", allocationSize = 1, initialValue = 1)
public class ContaAPagar implements Serializable {

	private static final long serialVersionUID = 1L;

	@Id
	@GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "seq_conta_a_pagar")
	private Long id;
